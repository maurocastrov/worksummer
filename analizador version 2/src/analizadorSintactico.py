...
directorio = '/Users/user/Documents/documentos universidad 5 semester/Compilador_PL0-master/analizador version 2/test/'
...
#ejemplo = yacc.build_lritems()
print result 
#print ejemplo.parse(cadena)

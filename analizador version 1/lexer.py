...
DELIM = [".", ";", ":", ",", ")"]
ignore_comment = ["/", "{", "("]
reservadas = ['array', 'downto', 'function', 'of', 'repeat', 'until', 'begin', 'else', 'goto', 'packed', 'set', 'var',
              'case', 'end', 'if', 'procedure', 'then', 'while', 'const', 'file', 'label', 'program', 'to', 'with',
    ...
    def siguientelexico(self):
        ...
        while True:
            if self.condition == "S":
                ...
                raise lexico(
                    'Dear Klenin there is a mistake in char: ' + str(self.firstchar) + ' ,line: ' + str(self.firstline))
                ...
                if self.lecturaprimersimbolo.isdigit():
                    ...
                    self.lex="{:.0f}".format(float(self.save))
                    break
                ...
                if self.lecturaprimersimbolo.isdigit():
                    ...
                    self.lex="{:.21f}".format(float(self.save))
                    break
                ...
                if self.save == "..":
                    ...
                    # self.condition="finish"
                    break
            elif self.condition == "string":
                if self.lecturaprimersimbolo == "\n" or not self.lecturaprimersimbolo:
                    raise lexico(
                        'Dear Klenin there is a mistake in char: ' + str(self.firstchar) + ' ,line: ' + str(
                            self.firstline))
                elif self.lecturaprimersimbolo != "'":
                    self.save += self.lecturaprimersimbolo
                else:
